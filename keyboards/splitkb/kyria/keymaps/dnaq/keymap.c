...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT_wrapped(
     ...
     _____________________QWERTY__L3_____________________,   NUM_BSP,  KC_TAB,KC_DEL, KC_SPC, _____________________QWERTY__R3_____________________,
                                    KC_NO, OSM_LSF, MO(_SM), NUM_BSP,  KC_TAB,KC_DEL, KC_SPC, NAV_ENT, OSM_RSF, KC_NO
  ),
  [_SM] = LAYOUT_wrapped(
